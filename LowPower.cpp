...
*
*******************************************************************************/
#if defined (__AVR_ATmega328P__) || defined (__AVR_ATmega168__) || defined (__AVR_ATmega88__) // MOD TG 06 sept 2018
									   ...
									   timer2_t timer2)
{
    ...
    #if  defined __AVR_ATmega88__   // MOD TG 06 sept 2018 lowPowerBOD not supported on Atmega88/88A
    #else
     	if (bod == BOD_OFF)
    	{
			#if defined __AVR_ATmega328P__
